...
**Convert column Job.Description into a corpus. Convert all of the words to lowercase to keep the consistency in text analysis. **
**Remove all punctuation, numbers, stopwords and white spaces to make make it possible to match with my key_term list.**
```{r}
